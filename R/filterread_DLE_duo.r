...
#' @param primaryGenesPresent boolean Whether primary genes are present or not.
...
#' type of SVs.
#' @return individual dsv files for each variant type if csv option is chosen.
#' @examples
#' \dontrun{
#' terms <- "Muscle Weakness"
...
run_bionano_filter_DLE_duo <- function(primaryGenesPresent = TRUE,
