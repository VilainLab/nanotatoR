...
#' nanotatoR_main_Duo_SE(
#' smap = smap, bed = bedFile, inputfmtBed = c("bed"), limsize = 1000,
#' n=3,EnzymeType = c("SE"),
...
#' termListPresent = FALSE, primaryGenesPresent = FALSE,
#' InternaldatabasePresent = TRUE,
#' outputType = c("Excel"))
#' }
#' @importFrom stats na.omit 
#' @export
nanotatoR_main_Duo_SE <- function(
