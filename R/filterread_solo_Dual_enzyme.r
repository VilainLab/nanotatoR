...
#'        input_fmt_geneList = c("dataFrame"),
...
#' @importFrom stats na.omit
#' @export
run_bionano_filter_singleton_Dual <- function(
    ...
    overlapPG <- rbind(datovrlapPG, datnonovrlapUPPG, datnonovrlapDNPG)
    ...
    if (outputType == "Excel"){
        list_of_datasets <- list(
            ...
            "all_PG_OV" = overlapPG, "mismatch" = dat6, "all" = data
        )
