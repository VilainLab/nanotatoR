...
transconf = .1
limsize= 1000
intFreq<-internalFrequency(smappath = smappath , buildSVInternalDB = TRUE, soloPath= path, solopattern = pattern,outpath = path,input_fmt_INF= "Text",win_indel,limsize = limsize,win_inv_trans= 50000, perc_similarity ,indelconf, invconf ,transconf,returnMethod_Internal = "dataFrame")
intFreq[1:2,]
```
