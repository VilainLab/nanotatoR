...
intFreq<-internalFrequency(smappath = smappath , buildSVInternalDB = TRUE, soloPath= path, solopattern = pattern,outpath = path,input_fmt_INF= "Text",win_indel = 10000,limsize= 1000,win_inv_trans= 50000, perc_similarity = 0.5 ,indelconf = 0.5, invconf = 0.01, transconf = 0.1, returnMethod_Internal = "dataFrame")
intFreq[1:2,]
```
